...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        return await user.send_message(chat_id, "✅الحساب المساعد دخل حبيبي")
    except UserAlreadyParticipant:
        return await user.send_message(chat_id, "✅الحساب المساعد موجود بعد كلبي")
...
async def leave_chat(c :Client, m: Message):
    ...
    try:
        if chat_id in QUEUE:
            ...
            return await c.send_message(chat_id, "✅ صوجي اغنيلكم كل واحد صماخه شكبره ")
        else:
            await user.leave_chat(chat_id)
            return await c.send_message(chat_id, "✅ طالع وزعلان هم باي ")
    except UserNotParticipant:
        return await c.send_message(chat_id, "🦴 غادر صارله شكد شبيكم صدك جذب ")
