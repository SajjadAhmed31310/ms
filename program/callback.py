...
-› [Source Sezar 𖢅](http://t.me/sourcesezar)
""",
...
async def at_set_markup_menu(_, query: CallbackQuery):
    ...
    if not a.can_manage_voice_chats:
        return await query.answer("💡 لا يمكنك الضغط هنا يا حبيبي فقط الي عنده صلاحية الكول            !", show_alert=True)
    ...
    if chat_id in QUEUE:
        ...
        await query.answer("ماكو شي شغال يا كلبي 🌵.", show_alert=True)
