...
async def stop(client, m: Message):
    ...
    if chat_id in QUEUE:
        ...
        await m.reply_text("ماكو شي شغال حبيبي")
...
async def cbpause(_, query: CallbackQuery):
    ...
    if not a.can_manage_voice_chats:
        return await query.answer("الي عدهم صلاحية الكول بس الي يكدرون يدوسون هنا", show_alert=True)
...
async def cbresume(_, query: CallbackQuery):
    ...
    if chat_id in QUEUE:
        ...
        await query.answer("ماكو شي شغال حبيبي", show_alert=True)
